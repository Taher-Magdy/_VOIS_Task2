...
import static org.example.Utilities.DataUtils.getConfigValue;
import static org.example.Utilities.WaitsUtils.*;
...
public class Utility {
    ...
    public static void clickToOpenInNewTab(WebDriver driver, By locator) {
        explicitlyWaitForClickability(driver, locator);
        findWebElement(driver, locator).sendKeys(Keys.chord(Keys.CONTROL, Keys.RETURN));
    }
